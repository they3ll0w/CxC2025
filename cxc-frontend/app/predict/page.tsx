...
export default function Predict() {
    ...
    return (
        <MainLayout>
            <div className="h-full flex flex-col gap-4 md:items-center md:justify-center dark:bg-zinc-800 overflow-hidden p-4">
                <h1 className="text-xl font-bold">Select events to predict the next one</h1>

                <div className="grid grid-cols-3 gap-2 w-full h-[60%]">

                    <Command className="col-span-2 rounded-lg dark:bg-zinc-400 dark:text-zinc-800 border shadow-md md:min-w-[450px]">
                ...
                {prediction && (
                    <div className="text-xs mt-2 px-4 py-2 bg-green-200 dark:bg-green-700 text-green-900 dark:text-green-200 rounded shadow-md">
                        <span className="font-semibold">
                            Predicted Next Event: </span>
